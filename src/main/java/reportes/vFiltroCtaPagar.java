 ...
 * @author vic-h
 */
public class vFiltroCtaPagar extends javax.swing.JDialog {
private int returnStatus = RET_CANCEL;
     ...
     */
    public vFiltroCtaPagar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        jdt_fechahasta.setDate(new Date());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vFiltroCtaPagar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                vFiltroCtaPagar dialog = new vFiltroCtaPagar(new javax.swing.JFrame(), true);
