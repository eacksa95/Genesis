...
public class tableModel {
    ...
    private String createPKKeyValueList(Map<String, String> whereClause, String separator){
        ...
        rows = this.tableKeys.size();
        row = 1;
        Iterator<String> arrayIterator = this.tableKeys.iterator();
        //System.out.println("Claves primarias "+this.tableKeys.toString());
    ...
    public ArrayList<Map<String, String>> readRegister(Map<String, String> fielsToSelect, Map<String, String> conditions){
