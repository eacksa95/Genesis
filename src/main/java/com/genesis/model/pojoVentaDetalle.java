...
public class pojoVentaDetalle {
    ...
    public pojoVentaDetalle(){

    }

    public pojoVentaDetalle(int ventaid, String cod_barra, String descripcion, double precio, double cantidad, double descuento, double bonificado, double total) {
