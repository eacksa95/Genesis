...
public class wCiudad extends javax.swing.JInternalFrame implements ActiveFrame {
    ...
    public wCiudad(String Opcion) {
        ...
        tc.init("ciudades");
        this.currentField = "";
        cargaComboBox.pv_cargar(jcbDepartamento, "departamentos", " id, nombre ", "id", "");
    }

    private void setData() {
        myData.put("id", tf_id.getText());
        myData.put("nombre", tf_nombre.getText());
        myData.put("departamentoid", Tools.ExtraeCodigo(jcbDepartamento.getSelectedItem().toString()));
    }//fin setData
        ...
        for (Map.Entry<String, String> entry : data.entrySet()) {
            ...
            switch (key) {
                ...
                case "nombre":
                    ...
                    break;
                case "departamentoid":
                    Tools.E_estado(jcbDepartamento, "departamento", "id=" + value);
                    break;
            }//end switch
        }//end for
    }//end fill
        ...
        switch (currentField) {
            case "id":
                sql = "SELECT id AS codigo ,"
                        ...
                        + "FROM ciudades "
                        + "WHERE LOWER(CONCAT(id, nombr)) LIKE '%";
                break;
            case "idOtro":
